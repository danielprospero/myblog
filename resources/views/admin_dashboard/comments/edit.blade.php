			...
			<div class="page-content">
				...
				<div class="card">
				  <div class="card-body p-4">
					  	<h5 class="card-title">Editar Comentrário</h5>
					  	<hr/>
                    ...
                    <form action="{{ route('admin.comments.update', $comment) }}" method='post'>
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="border border-3 p-4 rounded">
										...
										<button class='btn btn-primary' type='submit'>Editar Comentrário</button>
                                        <a class='btn btn-danger' href="#" onclick="event.preventDefault(); document.getElementById('comment_delete_form_{{$comment->id}}').submit();">Deletar Comentrário</a>
                            ...
                            <form action="{{ route('admin.comments.destroy', $comment) }}" method='post' id='comment_delete_form_{{$comment->id}}'>
								@csrf
								@method('DELETE')
							</form>
