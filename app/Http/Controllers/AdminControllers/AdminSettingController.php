...
class AdminSettingController extends Controller
{
    ...
    public function update()
    {
        $validated = request()->validate([
                'about_first_text' => 'required|min:100, max:500',
                'about_second_text' => 'required|min:100, max:500',
                'about_first_image' => 'nullable|image|mimes:jpg,png,jpeg,wepb,gif',
                'about_second_image' => 'nullable|image|mimes:jpg,png,jpeg,wepb,gif',
        ...
        return redirect()->route('admin.setting.edit')->with('success', 'Pagina de about foi atualizada com sucesso!');
